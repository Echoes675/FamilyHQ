...
namespace FamilyHQ.Data.PostgreSQL.Migrations
{
    ...
    [Migration("20260921193640_MapEventRemindersWithValueConverter")]
    partial class MapEventRemindersWithValueConverter
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FamilyHQ.Core.Models.CalendarInfo", b =>
                {
                    ...
                    b.Property<bool>("WebhooksSupported")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("FamilyHQ.Core.Models.WebhookRegistration", b =>
                {
                    ...
                    b.Property<string>("RegisteredAddressHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
