...
**Component:** E2E steps only — `tests-e2e/.../RecurringEventSteps.cs` (`the recurring event shows a recurrence indicator`) and `tests-e2e/.../SyncResilienceSteps.cs` (`I wait for the failed sync run to be recorded`). No production code involved.
